        ...
        <figure class="air-evidence air-document-evidence reveal" data-air-evidence="mawb-hawb" aria-labelledby="air-documents-caption">
            <div class="air-document-preview" role="img" aria-label="نمای ارتباط پرونده حمل هوایی با MAWB و چند HAWB در سپند">
                <div class="air-document-root">
                    ...
                    <strong dir="ltr"><?php echo e($airDemo['shipment']['reference']); ?></strong>
                    <small>۳ بسته · <bdi dir="ltr">PVG → DXB → IKA</bdi></small>
                </div>
                <i class="air-document-link" aria-hidden="true">↓</i>
                <article class="air-mawb-card">
                    <header><span>بارنامه مادر هوایی</span><span class="air-status is-confirmed"><?php echo e($documents['mawb']['status']); ?></span></header>
                    <h3>MAWB <bdi dir="ltr"><?php echo e($documents['mawb']['number']); ?></bdi></h3>
                    <p>پیش‌شماره ایرلاین · <bdi dir="ltr"><?php echo e($documents['mawb']['airline_prefix']); ?></bdi></p>
                </article>
                <i class="air-document-link" aria-hidden="true">↓</i>
                <div class="air-hawb-grid" aria-label="HAWBهای متصل به MAWB">
                    <?php $__currentLoopData = $documents['hawbs']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $hawb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article>
                            <span>HAWB <?php echo e(str_pad((string) ($index + 1), 2, '0', STR_PAD_LEFT)); ?></span>
                            <strong dir="ltr"><?php echo e($hawb['number']); ?></strong>
                            <small>۱ بسته · <?php echo e($hawb['status']); ?></small>
                        </article>
        ...
        <figure class="air-evidence air-uld-evidence reveal" data-air-evidence="uld-assignment" aria-labelledby="air-uld-caption">
            <div class="air-uld-preview" role="img" aria-label="نمای تخصیص ULD نوع PMC به پرواز EK303 همراه تعداد بسته‌ها و وزن ناخالص در سپند">
                ...
                <div class="air-uld-copy">
                    <span>تخصیص ULD</span>
                    <h3 dir="ltr"><?php echo e($uld['number']); ?></h3>
                    <p>این ULD برای پرواز <bdi dir="ltr"><?php echo e($uld['flight']); ?></bdi> ثبت شده است.</p>
                </div>
                <dl class="air-uld-data">
                    <div><dt>نوع ULD</dt><dd dir="ltr"><?php echo e($uld['type']); ?></dd></div>
                    <div><dt>تعداد بسته‌ها</dt><dd><?php echo e($uld['pieces']); ?></dd></div>
                    <div><dt>وزن ناخالص</dt><dd dir="ltr"><?php echo e($uld['gross_weight']); ?></dd></div>
                    <div><dt>پرواز</dt><dd dir="ltr"><?php echo e($uld['flight']); ?></dd></div>
                    <div class="is-status"><dt>وضعیت</dt><dd><span class="air-status is-<?php echo e($uld['status_key']); ?>"><?php echo e($uld['status']); ?></span></dd></div>
                </dl>
            </div>
...
<?php /**PATH C:\project\sepand\portal-customer\resources\views/marketing/transport-modes/air-documents-uld.blade.php ENDPATH**/ ?>