...
<a
    class="floating-consultation-cta floating-consultation-cta--<?php echo e($floatingConsultationPlacement); ?>"
    id="floating-consultation-cta-<?php echo e($floatingConsultationPlacement); ?>"
    href="<?php echo e($floatingConsultationHref); ?>"
    aria-label="درخواست دمو و مشاوره نرم‌افزار حمل‌ونقل سپند"
    data-floating-consultation-cta="<?php echo e($floatingConsultationPlacement); ?>"
    data-ga-event="cta_click"
    data-ga-label="<?php echo e($floatingConsultationOnForm ? 'floating_consultation_form' : 'floating_consultation_global'); ?>"
>
...
<?php /**PATH C:\project\sepand\portal-customer\resources\views/layouts/partials/floating-consultation-cta.blade.php ENDPATH**/ ?>