...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'ورود به پورتال مشتریان'); ?> | سپند</title>
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('assets/images/favicon.png')); ?>?v=20260811">
    <link rel="stylesheet" href="<?php echo e(asset('assets/customer-portal/auth.css')); ?>?v=20260811">
</head>
<body>
<main class="auth-page">
    <section class="auth-main">
        <header class="auth-topbar">
            <a class="auth-brand" href="<?php echo e(route('home')); ?>" aria-label="سپند، صفحه اصلی">
        ...
        <footer class="auth-support">
            ...
            <a href="<?php echo e(route('home')); ?>#contact">ارتباط با پشتیبانی</a>
        </footer>
    </section>
...
<script src="<?php echo e(asset('assets/customer-portal/auth.js')); ?>?v=20260811" defer></script>
<?php echo $__env->yieldPushContent('scripts'); ?>
</body>
</html>
<?php /**PATH C:\project\sepand\portal-customer\resources\views/layouts/customer-auth.blade.php ENDPATH**/ ?>