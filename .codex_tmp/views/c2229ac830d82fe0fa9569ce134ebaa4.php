...
<section class="page-hero">
    <div class="container hero-inner">
        <div class="hero-copy reveal"><div class="breadcrumb"><a href="<?php echo e(route('home')); ?>">صفحه اصلی</a><svg viewBox="0 0 24 24" fill="none"><path d="m9 18 6-6-6-6" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg><span>تعرفه‌ها</span></div><h1>قیمت و تعرفه<br><span>نرم‌افزار حمل‌ونقل</span></h1><p>قیمت نرم‌افزار حمل‌ونقل بین‌المللی سپند بر اساس ماژول‌ها، تعداد کاربران، روش استقرار و سطح خدمات موردنیاز شرکت شما تعیین می‌شود.</p><div class="hero-actions"><a class="btn btn-primary" href="#plans">مقایسه پلن‌ها</a><a class="btn btn-outline" href="<?php echo e(route('modules')); ?>">مشاهده ماژول‌ها</a></div></div>
...
<section class="section" id="plans">
    <div class="container">
        ...
        <div class="pricing-grid">
            <article class="price-card reveal"><span class="price-name">برای شروع منظم</span><h3>پایه</h3><p>برای تیم‌هایی که می‌خواهند مشتریان و فعالیت‌های روزانه را ساختاریافته مدیریت کنند.</p><div class="price">استعلام تعرفه<small>بر اساس کاربران و ماژول‌ها</small></div><ul class="feature-list"><li>مدیریت مشتریان و سرنخ‌ها</li><li>وظایف و تقویم کاری</li><li>یادداشت و فایل‌ها</li><li>گزارش‌های پایه</li><li>پشتیبانی استاندارد</li></ul><a class="btn btn-outline" href="<?php echo e(route('consultation.create')); ?>" data-ga-event="cta_click" data-ga-label="pricing_basic_consultation">درخواست مشاوره</a></article>
            <article class="price-card featured reveal"><span class="popular">پیشنهاد سپند</span><span class="price-name">برای عملیات حرفه‌ای</span><h3>حرفه‌ای</h3><p>برای شرکت‌هایی که به مدیریت یکپارچه مشتری، حمل، عملیات و امور مالی نیاز دارند.</p><div class="price">استعلام تعرفه<small>طراحی‌شده برای فرایند شما</small></div><ul class="feature-list"><li>تمام امکانات پلن پایه</li><li>رزرو و مدیریت حمل</li><li>عملیات و رهگیری محموله</li><li>گردش کار پیشرفته</li><li>مالی، فاکتور و پرداخت</li><li>پشتیبانی اولویت‌دار</li></ul><a class="btn" href="<?php echo e(route('consultation.create')); ?>" data-ga-event="cta_click" data-ga-label="pricing_pro_consultation">انتخاب پلن حرفه‌ای</a></article>
            <article class="price-card reveal"><span class="price-name">برای مقیاس سازمانی</span><h3>سازمانی</h3><p>برای ساختارهای چندتیمی که به سفارشی‌سازی، کنترل دسترسی و استقرار اختصاصی نیاز دارند.</p><div class="price">تعرفه اختصاصی<small>متناسب با معماری سازمان</small></div><ul class="feature-list"><li>تمام ماژول‌های موردنیاز</li><li>کاربران و تیم‌های متعدد</li><li>سطوح دسترسی سفارشی</li><li>گزارش‌ها و فرایندهای اختصاصی</li><li>همراهی در استقرار</li><li>پشتیبانی سازمانی</li></ul><a class="btn btn-outline" href="<?php echo e(route('consultation.create')); ?>" data-ga-event="cta_click" data-ga-label="pricing_enterprise_consultation">گفت‌وگو با کارشناسان</a></article>
        </div>
    </div>
</section>
...
<section class="cta-wrap"><div class="container"><div class="cta reveal"><div class="cta-copy"><h2>برای دریافت پیشنهاد دقیق آماده‌اید؟</h2><p>چند دقیقه درباره ساختار تیم و فرایندها صحبت کنیم تا پلن مناسب شما مشخص شود.</p></div><div class="cta-action"><a class="btn" href="<?php echo e(route('consultation.create')); ?>" data-ga-event="cta_click" data-ga-label="pricing_bottom_consultation">درخواست برآورد تعرفه</a></div></div></div></section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.marketing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\project\sepand\portal-customer\resources\views/marketing/pricing.blade.php ENDPATH**/ ?>