        ...
        <figure class="road-evidence road-pod-preview reveal" data-road-evidence="delivery-pod" aria-labelledby="road-pod-caption">
            <div role="img" aria-label="نمای POD یا Proof of Delivery و تأیید تحویل محموله زمینی در سپند">
                <header class="road-preview-header">
                    <div><span>تأیید تحویل و POD</span><h3>تحویل در <bdi dir="ltr"><?php echo e($pod['destination']); ?></bdi></h3><p>پرونده <bdi dir="ltr"><?php echo e($pod['shipment']); ?></bdi></p></div>
                    <span class="road-status is-completed"><?php echo e($pod['delivery_status']); ?></span>
                </header>
                ...
                <div class="road-pod-layout">
                    <section class="road-delivery-card" aria-label="اطلاعات تحویل محموله">
                        ...
                        <dl>
                            <div><dt>پرونده حمل</dt><dd dir="ltr"><?php echo e($pod['shipment']); ?></dd></div>
                            <div><dt>مقصد</dt><dd dir="ltr"><?php echo e($pod['destination']); ?></dd></div>
                            <div><dt>زمان تحویل</dt><dd dir="ltr"><?php echo e($pod['delivered_at']); ?></dd></div>
                            <div><dt>تحویل‌گیرنده</dt><dd dir="ltr"><?php echo e($pod['received_by']); ?></dd></div>
                            <div><dt>وضعیت تحویل</dt><dd><span class="road-status is-completed"><?php echo e($pod['delivery_status']); ?></span></dd></div>
                            <div><dt>وضعیت POD</dt><dd><span class="road-status is-pod"><?php echo e($pod['pod_status']); ?></span></dd></div>
                        </dl>
                    </section>
                    ...
                    <article class="road-pod-document">
                        ...
                        <div><span>فایل تأیید تحویل</span><h3 dir="ltr"><?php echo e($pod['file_name']); ?></h3><p dir="ltr"><?php echo e($pod['document_type']); ?></p><time dir="ltr"><?php echo e($pod['uploaded_at']); ?></time><small><?php echo e($pod['pod_status']); ?></small></div>
                    </article>
                </div>
...
<?php /**PATH C:\project\sepand\portal-customer\resources\views/marketing/transport-modes/road-delivery-pod.blade.php ENDPATH**/ ?>