...
<section class="page-hero comparison-hub-hero">
    <div class="container hero-inner">
        <div class="hero-copy reveal">
            ...
            <div class="hero-actions"><a class="btn btn-primary" href="#selection-checklist">مشاهده چک‌لیست انتخاب</a><a class="btn btn-outline" href="<?php echo e(route('compare.index')); ?>">همه مقایسه‌ها</a></div>
        </div>
    ...
    <div class="container">
        ...
        <div class="capability-detail-grid">
            <?php $__currentLoopData = $criteria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $criterion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <article class="capability-detail-card reveal"><span class="capability-index"><?php echo e(str_pad($index + 1, 2, '0', STR_PAD_LEFT)); ?></span><h3><a href="<?php echo e($criterion['href']); ?>"><?php echo e($criterion['title']); ?></a></h3><p><?php echo e($criterion['description']); ?></p></article>
...
<section class="section soft" aria-labelledby="transport-modes-check-title">
    <div class="container"><div class="section-head reveal"><span class="section-label">روش‌های حمل</span><h2 class="section-title" id="transport-modes-check-title">پوشش روش حمل را با پرونده واقعی بسنجید</h2><p class="section-sub">وجود نام یک روش حمل کافی نیست؛ فیلدها، رویدادها، اسناد، هزینه‌ها و گزارش همان روش را بررسی کنید.</p></div><div class="transport-check-grid"><a href="<?php echo e(route('site.transport-modes.show', ['mode' => 'sea'])); ?>"><strong>حمل دریایی</strong><span>کانتینر، مسیر، اسناد و رویدادها</span></a><a href="<?php echo e(route('site.transport-modes.show', ['mode' => 'air'])); ?>"><strong>حمل هوایی</strong><span>رزرو، بارنامه، وزن و زمان‌بندی</span></a><a href="<?php echo e(route('site.transport-modes.show', ['mode' => 'road'])); ?>"><strong>حمل زمینی</strong><span>خودرو، راننده، مرز و هزینه سفر</span></a><a href="<?php echo e(route('site.transport-modes.show', ['mode' => 'rail'])); ?>"><strong>حمل ریلی</strong><span>واگن، ایستگاه، مسیر و اسناد ریلی</span></a></div></div>
</section>
