            ...
            <div class="air-weight-preview" role="img" aria-label="محاسبه وزن واقعی Actual Weight، وزن حجمی Volumetric Weight و Chargeable Weight در پرونده حمل هوایی سپند">
                <header class="air-weight-example__head">
                    <div>
                        ...
                        <h3>محموله · <?php echo e($toPersianDigits($weight['cartons'])); ?> کارتن</h3>
                    </div>
                    <div class="air-divisor-control" aria-label="ضریب محاسبه وزن حجمی">
                        <span>ضریب محاسبه وزن حجمی</span>
                        <strong><?php echo e($toPersianDigits($weight['divisor'])); ?></strong>
                        <small><?php echo e($weight['divisor_mode'] === 'configurable' ? 'قابل تنظیم' : 'ثابت'); ?> · <?php echo e($toPersianDigits(implode(' / ', $weight['available_divisors']))); ?></small>
                    </div>
                </header>

                <div class="air-weight-inputs" aria-label="ورودی‌های مثال محاسبه وزن حجمی">
                    <div><span>تعداد کارتن‌ها</span><strong><?php echo e($toPersianDigits($weight['cartons'])); ?></strong></div>
                    <div><span>ابعاد هر کارتن</span><strong dir="ltr"><?php echo e($dimensions['length']); ?> × <?php echo e($dimensions['width']); ?> × <?php echo e($dimensions['height']); ?> <?php echo e($dimensions['unit']); ?></strong></div>
                    <div><span>وزن واقعی / ناخالص</span><strong dir="ltr"><?php echo e($weight['actual_weight']); ?> <?php echo e($weight['weight_unit']); ?></strong></div>
                </div>

                <div class="air-weight-formula" aria-label="فرمول نمونه وزن حجمی">
                    <span>وزن حجمی</span>
                    <code dir="ltr"><?php echo e($dimensions['length']); ?> × <?php echo e($dimensions['width']); ?> × <?php echo e($dimensions['height']); ?> × <?php echo e($weight['cartons']); ?> ÷ <?php echo e($weight['divisor']); ?> = <?php echo e($weight['volumetric_weight']); ?> <?php echo e($weight['weight_unit']); ?></code>
                </div>

                <div class="air-weight-results" aria-label="نتیجه مقایسه وزن واقعی و حجمی">
                    <article><span>وزن واقعی</span><strong dir="ltr"><?php echo e($weight['actual_weight']); ?> <?php echo e($weight['weight_unit']); ?></strong></article>
                    <article><span>وزن حجمی</span><strong dir="ltr"><?php echo e($weight['volumetric_weight']); ?> <?php echo e($weight['weight_unit']); ?></strong></article>
                    <article class="is-chargeable"><span>Chargeable Weight</span><strong dir="ltr"><?php echo e($weight['chargeable_weight']); ?> <?php echo e($weight['weight_unit']); ?></strong><small>عدد بزرگ‌تر انتخاب می‌شود</small></article>
                </div>
