...
$targets = [
    ...
    'email-workflow' => $module('email-workflow-automation', 'اتصال ایمیل سازمانی به مشتری و پرونده حمل', ['اتوماسیون ایمیل حمل‌ونقل', 'اتصال Inbox به پرونده حمل', 'Email Workflow فورواردری', 'Timeline ایمیل مشتری و Shipment']),
...
return [
    ...
    'pages' => [
        ...
        '/modules/crm' => $page(1, 'Sales', ['pricing-sales', 'sales-automation', 'booking', 'product', 'automatic-tasks', 'email-workflow']),
