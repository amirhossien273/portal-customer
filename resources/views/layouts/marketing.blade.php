...
<footer class="site-footer">
    <div class="container">
        <div class="footer-grid">
            ...
            <div class="footer-col"><h3>سپند</h3><a href="{{ route('about') }}">درباره ما</a><a href="{{ route('faq') }}">سؤالات متداول نرم‌افزار</a><a href="{{ route('compare.sepand-other-transport-software') }}">مقایسه سپند با نرم‌افزارهای دیگر</a><a href="{{ route('home') }}#why-us">مزیت‌های قابل سنجش</a><a href="{{ route('home') }}#process">گردش کار هوشمند محصول</a></div>
