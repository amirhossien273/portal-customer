...
<body x-data="main" class="antialiased relative font-iransans text-sm font-normal overflow-x-hidden"
    ...
    @include('components.common.flash-alerts')
    <div
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const messages = [
                ...
                @endif
                @if(session('status'))
                    { type: 'info', text: @json(session('status')) },
                @endif
            ];
    ...
    {{-- Loaded last so component-level inline styles cannot override mobile UX rules. --}}
