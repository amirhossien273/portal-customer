        ...
        <div class="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-[#0e1726]">
            ...
            <div class="ltr:mr-2 rtl:ml-2 hidden sm:block">
                <ul class="flex items-center space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                                            ...
                                            <div class="grid place-content-center rounded">
                                                <div class="w-12 h-12 relative">
                                                    <img class="w-12 h-12 rounded-full object-cover"
                                                        src="{{ auth()->user()->medias_with_url[0]['url'] ?? asset('assets/images/user-profile.jpeg') }}"
                                                        alt="image" />
                                                    <span
                                ...
                                <template x-if="notifications.length">
                                    <li>
                                        <div class="grid gap-2 p-4">
                                            ...
                                            <a href="{{ route('notifications.index') }}" class="btn btn-outline-primary block w-full btn-small text-center">
                                                مشاهده همه اعلان‌ها
                                            </a>
                                        </div>
                                    </li>
                    ...
                    @foreach(auth()->user()->menus('header') as $menu)
                      @if($menu->route === null)
                            ...
                            <li x-data="notificationDropdown()" @click.outside="open = false">
                                ...
                                <div class="dropdown">
                                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                                        ...
                                        <li>
                                            <div class="flex items-center px-4 py-2 justify-between font-semibold hover:!bg-transparent">
                                                <h4 class="text-lg">{{$menu->title}}</h4>
                                            </div>
                                        </li>
                      ...
                      @else
                        <li>
                            ...
                            @if($menu->route === 'chats.index') x-data="chatUnreadBadge()" @endif
                ...
                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                    <a href="javascript:;" class="relative group" @click="toggle()">
                        <span><img class="w-9 h-9 rounded-full object-cover saturate-50 group-hover:saturate-100"
                                   src="{{ auth()->user()->medias_with_url[0]['url'] ?? asset('assets/images/user-profile.jpeg') }}" alt="image" /></span>
                    </a>
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                        ...
                        <li>
                            <div class="flex items-center px-4 py-4">
                                ...
                                <div class="ltr:pl-4 rtl:pr-4 truncate">
                                    <h4 class="text-base">{{ auth()->user()->fullname }}
{{--                                        <span class="text-xs bg-success-light rounded text-success px-1 ltr:ml-2 rtl:ml-2">Pro</span>--}}
                                    </h4>
                                    <a class="text-black/60  hover:text-primary dark:text-dark-light/60 dark:hover:text-white"
                                       href="javascript:;">{{ auth()->user()->mobile }}</a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <a href="{{ route('auth::users.updateProfile') }}" class="dark:hover:text-white" @click="toggle">
...
<script>
    document.addEventListener("alpine:init", () => {
        ...
        Alpine.data('chatUnreadBadge', () => ({
            ...
            async fetchCount() {
                try {
                    const res = await fetch('{{ route('chats.unread-count') }}', {
                        headers: {
