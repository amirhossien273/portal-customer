...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/home.css') }}?v=20260907-1">
    ...
    <footer class="site-footer">
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-col"><h3>راهکارها</h3><a href="{{ route('solutions.index') }}">همه راهکارهای سپند</a><a href="{{ route('site.modules.show', ['module' => 'document-management']) }}">مدیریت اسناد حمل</a><a href="{{ route('solutions.platform.show', ['solution' => 'fleet-management']) }}">مدیریت ناوگان</a><a href="{{ route('solutions.nvocc') }}">راهکار NVOCC</a></div>
