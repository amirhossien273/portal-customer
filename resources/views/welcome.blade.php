    ...
    <footer class="site-footer">
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-col"><h3>دسترسی سریع</h3><a href="{{ route('modules') }}">ماژول‌ها</a><a href="{{ route('compare.sepand-other-transport-software') }}">مقایسه سپند با نرم‌افزارهای دیگر</a><a href="{{ route('pricing') }}">تعرفه‌ها</a><a href="{{ route('faq') }}">سؤالات متداول</a><a href="{{ route('about') }}">درباره ما</a></div>
