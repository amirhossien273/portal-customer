...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/home.css') }}?v=20260906-1">
    ...
    <footer class="site-footer">
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-col"><h3>دسترسی سریع</h3><a href="{{ route('product') }}">معرفی محصول</a><a href="{{ route('modules') }}">ماژول‌ها</a><a href="{{ route('solutions.index') }}">راهکارهای تخصصی</a><a href="{{ route('compare.index') }}">مرکز مقایسه نرم‌افزارها</a><a href="{{ route('pricing') }}">تعرفه‌ها</a><a href="{{ route('faq') }}">سؤالات متداول</a><a href="{{ route('about') }}">درباره ما</a></div>
                <div class="footer-col"><h3>راهکارها</h3><a href="{{ route('solutions.index') }}">همه راهکارهای سپند</a><a href="{{ route('solutions.nvocc') }}">مدیریت عملیات NVOCC</a><a href="{{ route('solutions.container-management') }}">مدیریت کانتینر</a><a href="{{ route('solutions.bill-of-lading-management') }}">مدیریت بارنامه</a><a href="{{ route('solutions.freight-sales-automation') }}">اتوماسیون فروش حمل‌ونقل</a><a href="{{ route('solutions.on-premise') }}">استقرار On-Premise</a></div>
