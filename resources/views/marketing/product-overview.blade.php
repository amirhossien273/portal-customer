            ...
            <div class="product-workflow-proof reveal" id="workflow-evidence">
                <div>
                    ...
                    <div class="product-workflow-links">
                        <a href="{{ route('site.modules.show', ['module' => 'automatic-tasks']) }}">قوانین وظیفه خودکار</a>
                ...
                <div class="product-workflow-thumbs">
                    <button type="button" data-product-lightbox-open data-image-src="{{ asset('assets/images/marketing/modules/screenshots/automatic-task-rules.webp') }}" data-image-alt="قوانین واقعی ساخت وظیفه خودکار در سپند" data-image-caption="قوانین ساخت وظیفه خودکار، وضعیت فعال‌بودن و گزارش اجرا" aria-label="نمایش بزرگ‌تر قوانین وظیفه خودکار">
                        <img src="{{ asset('assets/images/marketing/modules/screenshots/automatic-task-rules.webp') }}" alt="قوانین واقعی ساخت وظیفه خودکار در سپند" width="1600" height="851" loading="lazy" decoding="async">
                    </button>
                    <button type="button" data-product-lightbox-open data-image-src="{{ asset('assets/images/marketing/modules/screenshots/workflow-notifications.webp') }}" data-image-alt="مرکز اعلان و یادآوری واقعی سپند" data-image-caption="اعلان‌های خوانده‌نشده، وظایف ارجاع‌شده و امکان تعویق یادآوری" aria-label="نمایش بزرگ‌تر مرکز اعلان‌ها">
    ...
    <section class="product-integration" aria-labelledby="integration-title">
        <div class="container">
            ...
            <div class="product-integration-track reveal" aria-label="اتصال مراحل پرونده در سپند">
                @foreach(['مشتری', 'CRM', 'استعلام', 'پیشنهاد نرخ', 'Booking', 'عملیات حمل', 'مالی', 'گزارش مدیریتی'] as $item)
                    <div><span>{{ str_pad($loop->iteration, 2, '0', STR_PAD_LEFT) }}</span><b>{{ $item }}</b></div>
                @endforeach
            </div>
        </div>
    </section>
