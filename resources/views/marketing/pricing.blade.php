...
<section class="cta-wrap"><div class="container"><div class="cta reveal"><div class="cta-copy"><h2>برای دریافت پیشنهاد دقیق آماده‌اید؟</h2><p>چند دقیقه درباره ساختار تیم و فرایندها صحبت کنیم تا پلن مناسب شما مشخص شود.</p></div><div class="cta-action"><a class="btn" href="{{ route('consultation.create') }}" data-ga-event="cta_click" data-ga-label="pricing_bottom_consultation">درخواست برآورد تعرفه</a></div></div></div></section>
@endsection
