...
<section class="page-hero">
    <div class="container hero-inner">
        <div class="hero-copy crm-hero-copy reveal">
            ...
            <p class="crm-lead">کارشناس از همان پرونده پیامک می‌فرستد و پیگیری را ادامه می‌دهد؛ مدیر نیز مشتریان پردرآمد، پرسود، پرکار با سود کم و کم‌حجمِ ارزشمند را با فرمول شفاف می‌بیند. اطلاعات تأییدشده سپس بدون ورود دوباره به فروش، Booking و عملیات منتقل می‌شود.</p>
...
<section class="section" aria-labelledby="crm-problems-title">
    <div class="container">
        ...
        <div class="crm-problem-grid">
            ...
            <article class="crm-problem-card reveal"><h3>بازاریابی و ارتباطات قابل‌ردیابی</h3><p>تماس‌ها، جلسات، پیامک‌ها، یادآوری‌ها و اقدامات بعدی کارشناسان در سیستم ثبت می‌شود تا هیچ مشتری بدون پیگیری نماند. مدیران نیز می‌توانند وضعیت مذاکرات و فعالیت تیم فروش را بررسی کنند.</p></article>
        </div>
...
<section class="cta-wrap"><div class="container"><div class="cta reveal"><div class="cta-copy"><h2>CRM سپند را با داده واقعی کسب‌وکار خود ارزیابی کنید</h2><p>در جلسه دمو، ثبت لید و مشتری، راهنمای تعاملی، پیگیری پیش‌فاکتور و تحلیل درآمد، سود و ارزش هر مشتری را با سناریوی تیم شما بررسی می‌کنیم.</p></div><div class="cta-action"><a class="btn" href="{{ route('consultation.create') }}" data-ga-event="cta_click" data-ga-label="crm_bottom_consultation">درخواست دموی نرم‌افزار CRM</a></div></div></div></section>
@endsection
