        ...
        ready(() => {
            ...
            document.querySelectorAll("a[href='#delete-log-modal']").forEach((elt) => {
                elt.addEventListener('click', (event) => {
                    ...
                    let message = "<?php echo e(__('Are you sure you want to delete this log file: :date ?')); ?>"
...
<?php echo $__env->make('log-viewer::bootstrap-5._master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sepand-crm/portal-customer-site/vendor/arcanedev/log-viewer/views/bootstrap-5/logs.blade.php ENDPATH**/ ?>