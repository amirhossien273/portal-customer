        ...
        <div class="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-[#0e1726]">
            ...
            <div class="ltr:mr-2 rtl:ml-2 hidden sm:block">
                <ul class="flex items-center space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                    ...
                    <li x-data="notificationDropdown(true)" @click.outside="open = false">
                        <a href="javascript:;"
                        class="notification relative block p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60"
                        @click="toggle">
                            ...
                            <span class="flex absolute w-3 h-3 ltr:right-0 rtl:left-0 top-0" x-cloak x-show="notifications.length > 0">
                                <span
                        ...
                        <div class="dropdown">
                            <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                                class="ltr:-left-2 rtl:-right-2 top-2 !py-0 text-dark dark:text-white-dark w-[300px] sm:w-[350px] divide-y dark:divide-white/10">

                                <li>
                                    <div class="flex items-center px-4 py-2 justify-between font-semibold hover:!bg-transparent">
                                        <h4 class="text-lg">پیام ها</h4>
                                        <template x-if="notifications.length">
                                            <span class="badge bg-primary/80" x-text="notifications.length + ' جدید'"></span>
                                        </template>
                                    </div>
                                </li>
                                ...
                                <template x-for="notification in notifications" :key="notification.id">
                                    <li class="dark:text-white-light/90">
                                        <div class="flex items-center px-4 py-2 group cursor-pointer" @click="openNotification(notification)">
                                            <div class="grid place-content-center rounded">
                                                <div class="w-12 h-12 relative">
                                                    <img class="w-12 h-12 rounded-full object-cover"
                                                        src="<?php echo e(auth()->user()->medias_with_url[0]['url'] ?? asset('assets/images/user-profile.jpeg')); ?>"
                                                        alt="image" />
                                                    <span
                                ...
                                <template x-if="notifications.length">
                                    <li>
                                        <div class="grid gap-2 p-4">
                                            <button class="btn btn-primary block w-full btn-small" @click="readAllNotifications()">
                                                خواندن همه پیام ها
                                            </button>
                                            <a href="<?php echo e(route('notifications.index')); ?>" class="btn btn-outline-primary block w-full btn-small text-center">
                                                مشاهده همه اعلان‌ها
                                            </a>
                                        </div>
                                    </li>
                    ...
                    <?php $__currentLoopData = auth()->user()->menus('header'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php if($menu->route === null): ?>

                            <li x-data="notificationDropdown()" @click.outside="open = false">
                                <a href="javascript:;"
                                class="setting relative block p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60"
                                @click="toggle">
                                ...
                                <div class="dropdown">
                                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                                        ...
                                        <li>
                                            <div class="flex items-center px-4 py-2 justify-between font-semibold hover:!bg-transparent">
                                                <h4 class="text-lg"><?php echo e($menu->title); ?></h4>
                                            </div>
                                        </li>
                                        <?php $__currentLoopData = $menu->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="dark:text-white-light/90 link-siting">
                                                <div class="flex items-center px-4 py-2 group" @click.self="toggle">
                                                    <div class="grid place-content-center rounded">
                                                        <div class="p-1 relative">
                                                        <svg style="color: #9b9b9b;" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <?php echo $menu->icon; ?>
                      ...
                      <?php else: ?>
                        <li>
                            ...
                            <?php if($menu->route === 'chats.index'): ?> x-data="chatUnreadBadge()" <?php endif; ?>
                            class="relative block p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60">
                                ...
                                <?php if($menu->route === 'chats.index'): ?>
                                    <span x-cloak
                                          x-show="count > 0"
                                          x-text="count > 99 ? '99+' : count"
                                          class="absolute -top-1 -right-1 inline-flex min-w-[18px] h-[18px] items-center justify-center rounded-full bg-danger px-1 text-[10px] font-bold leading-none text-white ring-2 ring-white dark:ring-[#0e1726]">
                                    </span>
                                <?php endif; ?>
                            </a>
                        </li>
            ...
            <div x-data="header"
                ...
                <div class="sm:ltr:mr-auto sm:rtl:ml-auto">
                    ...
                    <a href="<?php echo e(route('notifications.index')); ?>"
                       aria-label="اعلان‌ها"
                       class="notification relative block sm:hidden p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60">
                ...
                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                    <a href="javascript:;" class="relative group" @click="toggle()">
                        <span><img class="w-9 h-9 rounded-full object-cover saturate-50 group-hover:saturate-100"
                                   src="<?php echo e(auth()->user()->medias_with_url[0]['url'] ?? asset('assets/images/user-profile.jpeg')); ?>" alt="image" /></span>
                    </a>
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                        ...
                        <li>
                            <div class="flex items-center px-4 py-4">
                                ...
                                <div class="ltr:pl-4 rtl:pr-4 truncate">
                                    <h4 class="text-base"><?php echo e(auth()->user()->fullname); ?>


                                    </h4>
                                    <a class="text-black/60  hover:text-primary dark:text-dark-light/60 dark:hover:text-white"
                                       href="javascript:;"><?php echo e(auth()->user()->mobile); ?></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <a href="<?php echo e(route('auth::users.updateProfile')); ?>" class="dark:hover:text-white" @click="toggle">
                        ...
                        <li>
                            <form method="POST" action="<?php echo e(route('lock-screen.lock')); ?>">
                                <?php echo csrf_field(); ?>
                                <button type="submit"
                                        class="flex w-full items-center px-4 py-2 text-right dark:hover:text-white"
                                        @click="toggle">
                                <svg class="w-4.5 h-4.5 ltr:mr-2 rtl:ml-2 shrink-0" width="18" height="18"
                                     viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <li class="border-t border-white-light dark:border-white-light/10">
                            <form method="POST" action="<?php echo e(route('logout')); ?>" >
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="flex items-center gap-2 text-danger px-4 py-2">
            ...
            <li class="menu nav-item relative">
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <form method="POST" action="<?php echo e(route('lock-screen.lock')); ?>">
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="flex w-full items-center px-4 py-2 text-right">
                                قفل صفحه
                            </button>
                        </form>
                    </li>
...
<style>
    .notification{
        color: #f05555;
        background-color: #f055551a !important;
    }
    .setting{
        color: #2f9196;
        background-color: #2f91962e !important;
    }
    .link-siting:hover {
...
<script>
    document.addEventListener("alpine:init", () => {
        ...
        Alpine.data('notificationDropdown', (pollingEnabled = false) => ({
            open: false,
            notifications: [],
            ...
            async fetchNotifications({ silent = false } = {}) {
                try {
                    ...
                    const incomingNotifications = data.data || [];
                    const newNotifications = incomingNotifications.filter((notification) => !this.knownNotificationIds.has(notification.id));

                    this.notifications = incomingNotifications;
                    this.knownNotificationIds = new Set(incomingNotifications.map((notification) => notification.id));

                    if (!silent && newNotifications.length) {
                        this.showNotificationAlert(newNotifications[0], newNotifications.length);
                    }
            ...
            async removeNotification(id) {
                if (!id) return;
                try {
                    await fetch(`/notifications/${id}/read`, { method: 'POST', headers: { 'Accept': 'application/json', 'X-Requested-With': 'XMLHttpRequest', 'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content } });
                    this.notifications = this.notifications.filter(n => n.id !== id);
                    this.knownNotificationIds.delete(id);
                } catch (e) { console.error(e) }
            },
            ...
            async readAllNotifications() {
                try {
                    await fetch('/notifications/read-all', { method: 'POST', headers: { 'Accept': 'application/json', 'X-Requested-With': 'XMLHttpRequest', 'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content } });
                    this.notifications = [];
                    this.knownNotificationIds.clear();
                } catch (e) { console.error(e) }
            },
            showNotificationAlert(notification, count = 1) {
                const alert = document.createElement('div');
                alert.className = 'fixed bottom-5 left-5 z-[99999] max-w-sm rounded-md bg-warning px-4 py-3 text-white shadow-lg';

                const message = count > 1
                    ? `${count} نوتیف جدید آمده`
                    : (notification.message || notification.title || 'نوتیف جدید آمده');

                const titleEl = document.createElement('div');
                titleEl.className = 'text-sm font-bold';
                titleEl.textContent = 'نوتیف جدید';

                const messageEl = document.createElement('div');
                messageEl.className = 'mt-1 text-xs leading-5';
                messageEl.textContent = message;

                alert.append(titleEl, messageEl);
        ...
        Alpine.data('chatUnreadBadge', () => ({
            count: 0,
            timer: null,
            init() {
                this.fetchCount();
                this.timer = setInterval(() => this.fetchCount(), 120000);
            },
            destroy() {
                if (this.timer) {
            ...
            async fetchCount() {
                try {
                    const res = await fetch('<?php echo e(route('chats.unread-count')); ?>', {
                        headers: {
...
<?php /**PATH /var/www/sepand-crm/portal-customer-site/resources/views/components/common/header.blade.php ENDPATH**/ ?>