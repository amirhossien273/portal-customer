...
<div class="task-jalali-picker" x-data="jalaliTaskPicker(<?php echo \Illuminate\Support\Js::from($value)->toHtml() ?>)" x-init="init()" @click.outside="open=false">
    <input id="<?php echo e($id); ?>" name="<?php echo e($name); ?>" class="form-input task-date-input w-full" x-model="value" @focus="show()" @click="show()" placeholder="مثال: 1405-02-24" readonly>
...
<?php if (! $__env->hasRenderedOnce('bc7ca02f-ea92-4a76-aea1-fe2c5010721c')): $__env->markAsRenderedOnce('bc7ca02f-ea92-4a76-aea1-fe2c5010721c'); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/sepand-crm/portal-customer-site/resources/views/components/jalali-date-picker.blade.php ENDPATH**/ ?>