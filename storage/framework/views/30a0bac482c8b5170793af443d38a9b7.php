...
<section class="page-hero comparison-competitor-hero">
    <div class="container hero-inner">
        <div class="hero-copy reveal">
            <div class="breadcrumb"><a href="<?php echo e(route('home')); ?>">صفحه اصلی</a><svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="m9 18 6-6-6-6" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg><a href="<?php echo e(route('compare.index')); ?>">مرکز مقایسه</a><svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="m9 18 6-6-6-6" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg><span>سپند و <?php echo e($comparison['name']); ?></span></div>
            <h1><?php echo e($comparison['h1']); ?></h1>
            <p><?php echo e($comparison['direct_answer']); ?></p>
        ...
        <div class="hero-art comparison-hero-art reveal" role="img" aria-label="مقایسه بی‌طرفانه نرم‌افزار سپند و <?php echo e($comparison['name']); ?>">
            <div class="comparison-visual competitor-visual">
                ...
                <div class="comparison-visual-option is-market"><span>راهکار رقیب</span><strong><?php echo e($comparison['name']); ?></strong><small>فقط اطلاعات عمومی قابل تأیید</small></div>
            </div>
        </div>
    </div>
</section>
...
<section class="comparison-source-strip" aria-label="روش و منبع بررسی">
    <div class="container"><strong>روش بررسی بی‌طرفانه:</strong><span>اطلاعات رقیب از <a href="<?php echo e($comparison['source_url']); ?>" target="_blank" rel="noopener noreferrer"><?php echo e($comparison['source_label']); ?></a> در تاریخ <?php echo e($comparison['source_checked_at']); ?> مرور شده است. نبود اطلاعات عمومی به معنای نبود قابلیت نیست.</span></div>
</section>

<section class="section soft" id="feature-comparison" aria-labelledby="feature-comparison-title">
    <div class="container">
        <div class="section-head reveal"><span class="section-label">مقایسه قابلیت‌ها</span><h2 class="section-title" id="feature-comparison-title">جدول مقایسه سپند و <?php echo e($comparison['name']); ?></h2><p class="section-sub">ستون وضعیت نشان می‌دهد آیا درباره رقیب اطلاعات عمومی وجود دارد یا موضوع باید در دمو و پیشنهاد رسمی تأیید شود.</p></div>
        ...
        <div class="comparison-table-wrap competitor-table-wrap reveal" tabindex="0" role="region" aria-labelledby="feature-comparison-title" aria-describedby="table-hint">
            <table class="comparison-table competitor-table">
                <caption>مقایسه قابلیت‌های نرم‌افزار سپند و <?php echo e($comparison['name']); ?></caption>
                <thead><tr><th scope="col">معیار</th><th scope="col">نرم‌افزار سپند</th><th scope="col"><?php echo e($comparison['name']); ?></th><th scope="col">وضعیت اطلاعات رقیب</th></tr></thead>
                <tbody>
                    <?php $__currentLoopData = $comparison['rows']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr><th scope="row"><?php echo e($row['criterion']); ?></th><td class="is-strong"><?php echo e($row['sepand']); ?></td><td><?php echo e($row['competitor']); ?></td><td><span class="<?php echo \Illuminate\Support\Arr::toCssClasses(['evidence-status', 'needs-review' => str_contains($row['state'], 'نیازمند'), 'has-public-info' => $row['state'] === 'اطلاعات عمومی موجود']); ?>"><?php echo e($row['state']); ?></span></td></tr>
        ...
        <div class="capability-detail-grid">
            <?php $__currentLoopData = $comparison['rows']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <article class="capability-detail-card reveal">
                    <h3><?php echo e($row['criterion']); ?></h3>
                    <p><strong>سپند:</strong> <?php echo e($row['sepand']); ?></p>
                    <p><strong><?php echo e($comparison['name']); ?>:</strong> <?php echo e($row['competitor']); ?></p>
                </article>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<section class="section soft" aria-labelledby="fit-title">
    <div class="container">
        ...
        <div class="decision-grid">
            <article class="decision-card is-product reveal"><h3>سپند برای چه شرکت‌هایی مناسب‌تر است؟</h3><ul><?php $__currentLoopData = $sepandFit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li><?php echo e($item); ?></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></ul></article>
            <article class="decision-card is-market reveal"><h3><?php echo e($comparison['name']); ?> برای چه شرکت‌هایی مناسب‌تر است؟</h3><ul><?php $__currentLoopData = $comparison['competitor_fit']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li><?php echo e($item); ?></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></ul><p class="fit-disclaimer">این موارد از جایگاه‌سازی عمومی محصول استخراج شده‌اند و توصیه قطعی خرید نیستند.</p></article>
        </div>
    </div>
</section>

<section class="section" aria-labelledby="main-difference-title">
    <div class="container"><div class="comparison-answer reveal"><span class="section-label">پاسخ مستقیم</span><h2 id="main-difference-title">تفاوت اصلی سپند و <?php echo e($comparison['name']); ?> چیست؟</h2><p><?php echo e($comparison['main_difference']); ?></p></div></div>
</section>
...
<section class="comparison-links" aria-labelledby="comparison-product-links-title"><div class="container"><h2 id="comparison-product-links-title">جزئیات ماژول‌های سپند</h2><nav aria-label="صفحات مرتبط محصول"><?php $__currentLoopData = $moduleLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><a href="<?php echo e(route('site.modules.show', ['module' => $item['slug']])); ?>"><?php echo e($item['label']); ?></a><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><a href="<?php echo e(route('pricing')); ?>">تعرفه‌ها</a><a href="<?php echo e(route('consultation.create')); ?>">درخواست دمو</a></nav></div></section>

<?php echo $__env->make('marketing.partials.comparison-cluster-links', ['comparisons' => $comparisons], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<section class="section soft" aria-labelledby="competitor-faq-title"><div class="container"><div class="section-head reveal"><span class="section-label">FAQ</span><h2 class="section-title" id="competitor-faq-title">سؤالات متداول مقایسه سپند و <?php echo e($comparison['name']); ?></h2></div><div class="faq"><?php $__currentLoopData = $comparison['faqs']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><details class="reveal"><summary><?php echo e($faq['question']); ?></summary><p><?php echo e($faq['answer']); ?></p></details><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></div></div></section>

<section class="cta-wrap"><div class="container"><div class="cta reveal"><div class="cta-copy"><h2>دموی سپند را با چک‌لیست خودتان برگزار کنید</h2><p>سناریوی واقعی شرکت را مطرح کنید تا قابلیت‌ها، موارد نیازمند تنظیم و محدوده قیمت بدون ادعای مقایسه‌ای بررسی شوند.</p></div><div class="cta-action"><a class="btn" href="<?php echo e(route('consultation.create')); ?>" data-ga-event="cta_click" data-ga-label="comparison_<?php echo e($comparison['slug']); ?>_consultation">درخواست دمو سپند</a></div></div></div></section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.marketing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\project\sepand\portal-customer\resources\views/marketing/compare-competitor.blade.php ENDPATH**/ ?>