...
<nav class="mobile-bottom-nav" aria-label="ناوبری اصلی موبایل" data-testid="mobile-bottom-nav">
    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <a href="<?php echo e($item['href'] ?? route($item['route'])); ?>"
           class="mobile-bottom-nav__item <?php echo e($item['active'] ? 'is-active' : ''); ?>"
...
<?php /**PATH /var/www/sepand-crm/portal-customer-site/resources/views/components/common/mobile-bottom-nav.blade.php ENDPATH**/ ?>