...
<?php if($slug === 'air'): ?>
    <?php $__env->startPush('styles'); ?>
        <link rel="stylesheet" href="<?php echo e(asset('assets/css/marketing-air-freight.css')); ?>?v=20260827-1">
    <?php $__env->stopPush(); ?>
        ...
        <div class="hero-art crm-hero-art reveal">
            <div class="art-panel module-hero-image-panel">
                <img
                    ...
                    alt="<?php echo e(in_array($slug, ['air', 'rail'], true) ? 'تصویر مفهومی عملیات ' . $mode['name'] . ' سپند' : 'تصویر سه‌بعدی ' . $mode['name'] . ' در نرم‌افزار سپند'); ?>"
                    width="1536"
                    height="1024"
                    loading="eager"
                    fetchpriority="high"
...
<section class="section" aria-labelledby="related-transport-title">
    <div class="container">
        <div class="section-head reveal"><span class="section-label">سایر حالت‌های حمل</span><h2 class="section-title" id="related-transport-title">مدیریت حمل چندوجهی در سپند</h2><p class="section-sub">پرونده‌های دریایی، هوایی، زمینی و ریلی در یک ساختار مشترک به فروش، <a href="<?php echo e(route('site.modules.show', ['module' => 'transport-operations'])); ?>">مدیریت عملیات حمل</a>، <?php if($slug === 'sea'): ?><a href="<?php echo e(route('site.modules.show', ['module' => 'document-management'])); ?>">مدیریت اسناد حمل</a><?php else: ?> اسناد <?php endif; ?> و مالی متصل می‌شوند.</p></div>
        <div class="crm-process-grid">
