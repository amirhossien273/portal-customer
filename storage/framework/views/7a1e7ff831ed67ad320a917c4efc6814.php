...
<head>
    ...
    <title><?php echo e($errorPageTitle); ?> | سپند</title>

    <link rel="icon" type="image/png" href="<?php echo e(asset('assets/images/brand/sepand-icon.png')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/IranSansFont.css')); ?>">
...
<body>
    <main class="page">
        <section class="card" aria-labelledby="error-title">
            <div class="content">
                <a class="logo" href="<?php echo e(url('/')); ?>" aria-label="صفحه اصلی سپند">
                    <picture>
                        <source srcset="<?php echo e(asset('assets/images/brand/sepand-logo-dark.png')); ?>" media="(prefers-color-scheme: dark)">
                        <img src="<?php echo e(asset('assets/images/brand/sepand-logo.png')); ?>" alt="سپند">
                    </picture>
                </a>

                <span class="eyebrow">خطای <?php echo e($localizedErrorCode); ?></span>
                <h1 id="error-title"><?php echo e($errorTitle); ?></h1>
                <p class="description"><?php echo e($errorDescription); ?></p>

                <div class="actions">
                    <a class="button button-primary" href="<?php echo e(url('/')); ?>">
                    ...
                    <button class="button button-secondary" type="button" onclick="history.length > 1 ? history.back() : location.assign('<?php echo e(url('/')); ?>')">
                        <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
            ...
            <div class="visual" aria-hidden="true">
                <div class="dots"></div>
                <div class="code"><?php echo e($errorCode); ?></div>
                <div class="illustration">
                    <div class="shield<?php echo e($errorCode === '404' ? ' is-not-found' : ''); ?>">
                ...
                <span class="visual-label"><?php echo e($errorVisualLabel); ?></span>
            </div>
        </section>
    </main>
</body>
</html>
<?php /**PATH /var/www/sepand-crm/portal-customer-site/resources/views/errors/403.blade.php ENDPATH**/ ?>