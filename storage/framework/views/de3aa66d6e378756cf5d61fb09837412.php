...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="/assets/mobile-app.css" />
    <link rel="stylesheet" type="text/css" media="screen" href="/assets/brand-theme.css?v=20260710-1" />
    ...
    <script>
        (function () {
            try {
                ...
                var isDark = localStorage.getItem('_x_isDarkMode') === 'true';
                if (theme) {
                    try { theme = JSON.parse(theme); } catch (error) { theme = theme.replace(/^\"|\"$/g, ''); }
                } else {
                    theme = 'light';
                }
                var dark = theme === 'dark' || isDark || (theme === 'system' && window.matchMedia('(prefers-color-scheme: dark)').matches);
...
<?php /**PATH /var/www/sepand-crm/portal-customer-site/resources/views/components/layout/auth.blade.php ENDPATH**/ ?>