...
<?php if(filled($actionToastMessage)): ?>
    <div x-data="{ show: true }"
         ...
         class="app-action-toast is-<?php echo e($actionToastType); ?>"
         role="<?php echo e($actionToastType === 'error' ? 'alert' : 'status'); ?>">
        <span class="app-action-toast__icon" aria-hidden="true">
            <?php if($actionToastType === 'error'): ?>
            ...
            <?php elseif($actionToastType === 'warning'): ?>
            ...
            <?php elseif($actionToastType === 'info'): ?>
        ...
        <div>
            <strong><?php echo e($actionToastTitle); ?></strong>
            <span><?php echo e($actionToastMessage); ?></span>
        </div>
        <button type="button" @click="show = false" aria-label="بستن">×</button>
    </div>
<?php endif; ?>

<?php if (! $__env->hasRenderedOnce('7502cb9b-5b7a-4a5e-898c-f61c0a13aa50')): $__env->markAsRenderedOnce('7502cb9b-5b7a-4a5e-898c-f61c0a13aa50'); ?>
    <style>
...
<?php endif; ?>
<?php /**PATH /var/www/sepand-crm/portal-customer-site/resources/views/components/common/action-toast.blade.php ENDPATH**/ ?>