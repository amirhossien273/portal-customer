...
<link rel="stylesheet" href="<?php echo e(asset('assets/css/marketing-comparison.css')); ?>?v=20260818-1">
<?php $__env->stopPush(); ?>
    ...
    <div class="container">
        ...
        <div class="criteria-grid">
            <article class="criteria-card reveal">
                ...
                <ul>
                    <li><a href="<?php echo e(route('site.modules.show', ['module' => 'crm'])); ?>">CRM تخصصی شرکت حمل‌ونقل</a> برای لید، مشتری و پیگیری</li>
                    <li><a href="<?php echo e(route('site.modules.show', ['module' => 'pricing-sales'])); ?>">مدیریت استعلام، نرخ و پیشنهاد قیمت</a></li>
                    <li><a href="<?php echo e(route('site.modules.show', ['module' => 'booking'])); ?>">Booking</a> و انتقال اطلاعات فروش به اجرای حمل</li>
                </ul>
            </article>
            <article class="criteria-card reveal">
                ...
                <ul>
                    <li><a href="<?php echo e(route('site.transport-modes.show', ['mode' => 'air'])); ?>">حمل هوایی</a>، <a href="<?php echo e(route('site.transport-modes.show', ['mode' => 'sea'])); ?>">دریایی</a>، <a href="<?php echo e(route('site.transport-modes.show', ['mode' => 'road'])); ?>">زمینی</a> و <a href="<?php echo e(route('site.transport-modes.show', ['mode' => 'rail'])); ?>">ریلی</a></li>
                    <li><a href="<?php echo e(route('site.modules.show', ['module' => 'transport-operations'])); ?>">عملیات حمل</a>، رویدادها، مسئولیت و موارد متوقف‌شده</li>
                    <li><a href="<?php echo e(route('site.modules.show', ['module' => 'document-management'])); ?>">مدیریت اسناد حمل</a>، نسخه، تأیید و مهلت</li>
                </ul>
            </article>
            <article class="criteria-card reveal">
                ...
                <ul>
                    <li><a href="<?php echo e(route('site.modules.show', ['module' => 'finance-accounting'])); ?>">حسابداری و مالی چندارزی</a></li>
            ...
            <article class="criteria-card reveal">
                ...
                <ul>
                    <li><a href="<?php echo e(route('site.modules.show', ['module' => 'customer-portal-tracking'])); ?>">Customer Portal</a>، سطح دسترسی کاربران و تاریخچه فعالیت</li>
    ...
    <div class="container">
        ...
        <ol class="workflow-grid">
            <?php $__currentLoopData = $workflowSteps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="workflow-card reveal" id="workflow-step-<?php echo e($index + 1); ?>">
                    <span class="workflow-number"><?php echo e(str_pad((string) ($index + 1), 2, '0', STR_PAD_LEFT)); ?></span>
                    <small dir="ltr"><?php echo e($step['label']); ?></small>
                    <h3><a href="<?php echo e($step['href']); ?>"><?php echo e($step['title']); ?></a></h3>
...
<section class="comparison-links" aria-labelledby="comparison-links-title">
    <div class="container">
        ...
        <nav aria-label="لینک‌های مرتبط با مقایسه">
            <a href="<?php echo e(route('site.modules.show', ['module' => 'crm'])); ?>">CRM شرکت حمل‌ونقل</a>
            <a href="<?php echo e(route('site.modules.show', ['module' => 'transport-operations'])); ?>">عملیات حمل</a>
            <a href="<?php echo e(route('site.modules.show', ['module' => 'document-management'])); ?>">مدیریت اسناد</a>
            <a href="<?php echo e(route('site.modules.show', ['module' => 'finance-accounting'])); ?>">مالی و سود پرونده</a>
            <a href="<?php echo e(route('site.modules.show', ['module' => 'customer-portal-tracking'])); ?>">پرتال مشتریان</a>
            <a href="<?php echo e(route('consultation.create')); ?>">درخواست دمو</a>
        </nav>
    </div>
</section>
...
<section class="cta-wrap"><div class="container"><div class="cta reveal"><div class="cta-copy"><h2>سپند را با فرایند واقعی شرکت خودتان مقایسه کنید</h2><p>در یک جلسه کوتاه، فرایند فعلی فروش، عملیات و مالی شرکت شما بررسی می‌شود تا مشخص شود سپند تا چه حد با نیازهای شما تطابق دارد.</p></div><div class="cta-action"><a class="btn" href="<?php echo e(route('consultation.create')); ?>" data-ga-event="cta_click" data-ga-label="comparison_other_software_consultation">درخواست دمو و مشاوره</a></div></div></div></section>
