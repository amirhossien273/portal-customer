    ...
    <div class="container">
        ...
        <figure class="rail-evidence rail-wagon-evidence reveal" data-rail-evidence="wagon-assignment" aria-labelledby="wagon-evidence-caption">
            ...
            <figcaption id="wagon-evidence-caption">
                تخصیص چند واگن به یک پرونده ریلی و مشاهده وضعیت مستقل هر واگن. داده‌های این نما نمونه‌اند و هنوز به موجودیت مستقل واگن در Backend متصل نیستند.
            </figcaption>
        </figure>
    </div>
</section>
    ...
    <div class="container">
        ...
        <figure class="rail-evidence rail-station-evidence reveal" data-rail-evidence="station-timeline" aria-labelledby="station-evidence-caption">
            ...
            <figcaption id="station-evidence-caption">
                خط زمانی نمونه ایستگاه‌های مبدأ، میانی و مقصد همراه ورود، خروج، توقف، تأخیر و تغییر واگن. این Evidence یک پیش‌نمایش رابط محصول است، نه اسکرین‌شات داده زنده.
            </figcaption>
        </figure>
    </div>
</section>
